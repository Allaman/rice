...
aur: ## Run AUR helper to install AUR packages
	...
	$(AUR_HELPER) -S masterpdfeditor urlview telepresence vscodium-bin  vidir glow google-cloud-sdk aws-session-manager-plugin postman nerd-fonts-fira-code xbanish keyd-git zeal
